...
public class Lab1 {
    ...
    public static void sumLastNumsTests(){
        //1.2 ТЕСТЫ
    ...
    public static void isPositiveTests(){
        //1.4 ТЕСТЫ
    ...
    public static void isUpperCaseTests(){
        //1.6 ТЕСТЫ
    ...
    public static void isDivisorTests(){
        //1.8 ТЕСТЫ
    ...
    public static void lastFiveNumSum(){
    ...
    public static void lastFiveNumSum(int[] array){
    ...
    public static void lastNumSumTests(){
        //1.10 ТЕСТЫ
    ...
    public static void safeDivTests(){
        //2.2 ТЕСТЫ
    ...
    public static void makeDecisionTests(){
        //2.4 ТЕСТЫ
    ...
    public static void printDaysTests(){
        //2.10 ТЕСТЫ
    ...
    public static void leftTraingleTest(){
        //3.8 ТЕСТЫ
    ...
    public static void guessGame(boolean auto) {
        //3.10 Угадайка
        int tries = 0;
